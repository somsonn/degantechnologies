...
<template>
  <div class="relative w-full max-w-5xl bg-gray-100 mx-auto mt-2">
    <!-- Heading -->
    <div class="absolute top-0 left-0 bg-blue-600 text-white text-lg font-semibold px-2 py-2 rounded-br-lg shadow-md">
      Clients
    </div>

    <!-- Carousel Container -->
    <div
      class="overflow-hidden rounded-xl shadow-md border-2 border-blue-600"
    >
      <!-- Slides -->
      <div
        ...
        >
          ...
          >
            <img
              :src="client.logo"
              alt="Client Logo"
              class="w-24 h-12 object-contain rounded-md border border-gray-200"
            />
