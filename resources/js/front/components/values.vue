<template>
  <section  id="slider" class="relative h-[80vh] mt-16 pt-10 overflow-hidden">
    <!-- Slider Images -->
...
const sliderData = ref([
  {
    ...
    description: "At Degan, we pride ourselves on delivering unparalleled services tailored to meet the diverse needs of our clients. From conceptualization to execution, we ensure quality at every touchpoint, fostering lasting relationships built on trust and excellence.",
  },
  {
    image: "/images/image.png",
    title: "Tailored Enterprise Solutions",
    description: "Our custom systems are designed to streamline your business processes, enhancing efficiency and reducing operational overheads. With our innovative enterprise solutions, you can focus on growth while we handle the complexities of digital integration.",
  },
  {
    image: "/images/degan1.png",
    title: "Digital Transformation Partner",
    description: "In an era of rapid change, Degan stands as your trusted ally in navigating digital transformation. We empower businesses with cutting-edge tools and strategies to unlock their true potential, ensuring they stay ahead in a competitive landscape.",
  },
]);
...
const prevImage = () => {
  currentIndex.value =
    (currentIndex.value - 1 + sliderData.value.length) % sliderData.value.length;
};
